...
def power_minus(num):
    """This function will be used to return a find a power of a 2. Example if 2 ** 8 is 256. so if we input
    256 in this function, we will get value 8"""
    return round(math.log(num,2))

"""
How to access elements
dictonary_name[register name][signal we are getting]
example: to see what is status after getting 10 from registor 8019 will be actuator_dict[8019][10] -> will give ["E","Forward",1]
"""
actuator_dict = {8019:{0:["A","Forward",1],1:["A","Backward",0],2:["B","Forward",1],
                       3:["B","Backward",0],8:["D","Forward",1],9:["D","Backward",0],
                       10:["E","Forward",1],11:["E","Backward",0]},
                 8018:{0:["G","Forward",1],1:["G","Backward",0],2:["H","Forward",1],
                       3:["H","Backward",0],4:["I","Forward",0],5:["I","Backward",0],
                       10:["K","Forward",0],11:["K","Backward",0],12:["L","Forward",0]},
                 8021:{2:["N","Forward",1],3:["N","Backward",0],4:["O","Forward",1],
                       5:["O","Backward",0],6:["P","Forward",1],7:["P","Backward",0]},
                 8020:{4:["T","Forward",1],5:["T","Backward",0],6:["U","Forward",1],
                       7:["U","Backward",0],8:["V","Forward",1],9:["V","Backward",0],
                       10:["W","Forward",1],11:["W","Backward",0]}
                 }

# same as above mention code.
conveyor_dict = {8002:{0:["A","Piece_at_Front",1],1:["A","Piece_at_End",0],2:["B","Piece_at_Front",1],
                       3:["B","Piece_at_End",0],8:["D","Piece_at_Front",1],9:["D","Piece_at_End",0],
                       10:["E","Piece_at_Front",1],11:["E","Piece_at_End",0]},
                 8001:{0:["G","Piece_at_Front",1],1:["G","Piece_at_End",0],2:["H","Piece_at_Front",1],
                       3:["H","Piece_at_End",0],4:["I","Piece_at_Front",0],5:["I","Piece_at_End",0],
                       10:["K","Piece_at_Front",0],11:["K","Piece_at_End",0],12:["L","Piece_at_Front",0]},
                 8004:{2:["N","Piece_at_Front",1],3:["N","Piece_at_End",0],4:["O","Piece_at_Front",1],
                       5:["O","Piece_at_End",0],6:["P","Piece_at_Front",1],7:["P","Piece_at_End",0]},
                 8003:{4:["T","Piece_at_Front",1],5:["T","Piece_at_End",0],6:["U","Piece_at_Front",1],
                       7:["U","Piece_at_End",0],8:["V","Piece_at_Front",1],9:["V","Piece_at_End",0],
                       10:["W","Piece_at_Front",1],11:["W","Piece_at_End",0]}}
...
out_1.get_input_register( offset=0, amount=1)
out_1.get_output_register( offset=0, amount=1)
out_1.set_output_register( register, offset=0)
out_1.get_offset( bit_nr)
out_1.get_bit( index, nr)
out_1.conveyor_stop(conveyor_id)
out_1.conveyor_forward(conveyor_id)
out_1.conveyor_backward(conveyor_id)
out_1.set_switch(switch_id, pos=0)
out_1.set_seperator(seperator_id)
out_1.reset_seperator(seperator_id)
out_1.check_conveyor_workpiece_begin(conveyor_id)
out_1.check_conveyor_workpiece_end(conveyor_id)
out_1.check_switch_position_reached(switch_id)
out_1.check_switch_in_movement(switch_id)
out_1.check_switch_workpiece(switch_id)
out_1.check_switch_in_reference_position(switch_id)
out_1.check_seperator_set(seperator_id)
out_1.check_seperator_workpiece_behind(seperator_id)
out_1.check_seperator_workpiece_in_front(seperator_id)
out_1.update_conveyor_speed()
out_1.set_conveyor_speed(conveyor_id, speed)
out_1.set_conveyor_speed_all(speed)
